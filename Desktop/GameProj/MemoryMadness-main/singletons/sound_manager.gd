...
func play_match_sound(player: AudioStreamPlayer) -> void:
	play_sound(player, SOUND_SUCCESS)

func play_no_match_sound(player: AudioStreamPlayer) -> void:
	play_sound(player, SOUND_NO_MATCH)
