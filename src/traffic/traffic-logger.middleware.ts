...
export class TrafficLoggerMiddleware implements NestMiddleware {
  ...
  async use(req: Request, res: Response, next: NextFunction) {
    ...
    if (originalUrl.includes("/auth/register"))
      activity = "Attempted Registration";
    if (originalUrl.includes("/tutors/apply"))
      activity = "Tutor Application Started";
    if (originalUrl.includes("/payments/request"))
      activity = "Payment Requested";
